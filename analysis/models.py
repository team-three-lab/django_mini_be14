...
class Analysis(models.Model):
    ...
    period = models.CharField("분석 기간", max_length=255, choices=ANALYSIS_TYPES)
    end_date = models.DateTimeField("분석 종료 날자")
    start_date = models.DateTimeField("분석 시작 날짜")
    description = models.TextField("분석 설명")
    result_image = models.CharField("분석 결과",max_length=255, blank=True)
